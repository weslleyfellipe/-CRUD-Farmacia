...
@Table(name="tb_produto")//nomeando a tabela no banco de dados de tb_produto
public class Produto {
	...
	@NotBlank(message = "Esse campo deve ser preenchido apenas com caracteres ! ")// validation - validar nosso atributo NN e tambem não vazio
	@Size(min= 1, max = 50 , message = "O atributo  nome  deve ter no minimo 1 caractere e no maximo 20 .")
